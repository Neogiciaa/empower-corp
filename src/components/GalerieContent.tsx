...
const images: GalerieImage[] = [
  ...
  { src: "/images/galerie-dicka-2.jpg", alt: "Titouan, responsable de campagne commercial",       pos: "50% 18%" },
  { src: "/images/galerie-2.jpg",       alt: "Benjamin, Business Coach chez One Project Marketing", pos: "50% 18%" },
